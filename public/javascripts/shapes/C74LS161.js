...
var C74LS161 = draw2d.SetFigure.extend({
    ...
    createSet: function() {
        ...
        shape.attr({ "x": 8.7734375, "y": 160, "text-anchor": "start", "text": "GND", "font-family": "\"Arial\"", "font-size": 8, "stroke": "none", "fill": "#080808", "stroke-scale": true, "font-weight": "normal", "stroke-width": 0, "opacity": 1 });
        shape.data("name", "Label_GND");

        // Label_nLD
        shape = this.canvas.paper.text(0, 0, '~LD');
        shape.attr({ "x": 69, "y": 159.5, "text-anchor": "start", "text": "~LD", "font-family": "\"Arial\"", "font-size": 8, "stroke": "none", "fill": "#080808", "stroke-scale": true, "font-weight": "normal", "stroke-width": 0, "opacity": 1 });
