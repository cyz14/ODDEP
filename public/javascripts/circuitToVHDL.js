...
var VHDLCode = {
    ...
    createNew: function() {
            ...
            code.incIndent();
                ...
                for (var port in code.entity.ports) {
                    ...
                    result += code.indentStr +
                        [port.name, ":", port.type, "STD_LOGIC"].join(" ");
                }
                result += "\n\n";
                code.decIndent();
                result += code.indentStr + ");" 
        ...
        code.marshalArchitecture = function() {
            ...
            result += 
                code.indentStr + 
                ["ARCHITECTURE", code.architecture.behaviour.name, "OF", 
                code.entity.name, "IS"].join(" ") + "\n";
        ...
        code.marshalArchitectureBehaviour = function() {
            ...
            result += code.indentStr + 
                ["END", code.architecture.behaviour.name].join(" ") + ";\n";
            return result;
        }
